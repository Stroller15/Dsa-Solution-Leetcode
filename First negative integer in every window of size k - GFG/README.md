...
<strong>{3, -6}</strong> = -6
<strong>{-6, 10}</strong> = -6</span><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
...
K = 3
<strong>Output :</strong>
-1 -1 -7 -15 -15 0 </span><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
