...
<pre style="position: relative;"><strong>Input:</strong> start = 10, goal = 7
...
It can be shown we cannot convert 10 to 7 in less than 3 steps. Hence, we return 3.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 2:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> start = 3, goal = 4
<strong>Output:</strong> 3
