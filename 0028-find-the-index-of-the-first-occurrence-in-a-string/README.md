...
<pre style="position: relative;"><strong>Input:</strong> haystack = "sadbutsad", needle = "sad"
...
<pre style="position: relative;"><strong>Input:</strong> haystack = "leetcode", needle = "leeto"
